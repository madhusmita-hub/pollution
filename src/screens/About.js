...
import {View, SafeAreaView, Text, StatusBar,Image, StyleSheet,TouchableOpacity, ScrollView} from 'react-native';
      ...
      <View style={styles.container}>
        <ScrollView>
          <View style={styles.pageContent}>
            <Image source={require('../assets/img/sample.jpg')} style={styles.imgStyle} />
            <Text style={styles.txtStyle}>{txt}
            </Text>
          </View>
        </ScrollView>
      </View>
